...
class WebViewPlus extends React.Component {
  ...
  static propTypes = {
    ...
    onOverrideLoadingUrl: PropTypes.func,
   ...
   if (this.state.viewState === WebViewState.LOADING) {
    ...
    const webView =
      <NativeWebView
        ...
        onOverrideLoadingUrl={this.onOverrideLoadingUrl}
  ...
  */
  ...
  onOverrideLoadingUrl = (event: Event) => {
    const {onOverrideLoadingUrl} = this.props;
    onOverrideLoadingUrl && onOverrideLoadingUrl(event.nativeEvent.url);
  }
}
